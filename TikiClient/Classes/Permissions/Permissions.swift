...
public enum Permission {
    ...
    public func requestAuth(_ completion: @escaping ((Bool) -> Void) = {_ in }) {
        switch self {
            ...
            case .locationAlways:
                TikiClient.location.locationManager.requestAlwaysAuthorization()
                completion(TikiClient.location.locationManager.authorizationStatus == .authorizedAlways || TikiClient.location.locationManager.authorizationStatus == .authorizedAlways)
            case .locationInUse:
                TikiClient.location.locationManager.requestWhenInUseAuthorization()
                completion(TikiClient.location.locationManager.authorizationStatus == .authorizedWhenInUse)
            case .notifications:
